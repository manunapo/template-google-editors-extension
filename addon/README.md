...
There are two steps to getting started: making a port forwarding, and running the start command.

1. Making a https -> http tunnel. 

    Option 1: Using vscode/cursor Ports feature.

    Go to Ports and open the port 3000, make it public
...
3. Add `<script src="http://localhost:8097"></script>` to the top of your `<head>` in your React app, e.g. in the index.html file in the sidebar app.
